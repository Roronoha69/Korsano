...
export default ({
  ...
  faqs = [
      ...
      "Nos programmes sont personnalisés entièrement pour les hommes comme pour les femmes."    },
    {
      ...
      answer:
      "Oui. Nous remplaçons les poissons et les viandes par des féculents et céréales comme le tofu. Nous n'avons pas d'options disponibles pour les végans" },
    {
      question: "Sous quel format je recevrai mon plan personnalisé ?",
      answer:
      "Tu peux le consulter ou l'enregistrer en PDF directement depuis notre site web"    },
    {
