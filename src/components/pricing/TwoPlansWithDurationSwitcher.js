...
export default ({
  ...
  plans = null,
  primaryButtonText = "Démarer",
  planDurations = [
    {
      text: "",
      switcherText: "Nutrition",
    },
    {
      text: "",
      switcherText: "Calisthenics",
    }
  ]
}) => {
  const defaultPlans = [
    {
      name: "Gratuit",
      durationPrices: ["0€", "X€"],
      mainFeature: "Plan personaisé 1 jour",
      features: ["1 journée type", "7 Landing Pages", "12 Internal Pages", "Basic Assistance"],
      btn: "Démarer"
    },
    {
      name: "Payant",
      durationPrices: ["17€", "X€"],
      mainFeature: "Plan personalisé 14 jours",
      features: ["2 semaines de diète", "Détails Calories et macronutriments", "22 Internal Pages", "Priority Assistance", "Lifetime Updates"],
      featured: true,
      btn: "Acheter"
    }
  ];
        ...
        <PlansContainer>
          {plans.map((plan, index) => (
            <Plan key={index} featured={plan.featured}>
              ...
              <PlanAction>
                <BuyNowButton>{plan.btn}</BuyNowButton>
              </PlanAction>
            </Plan>
          ))}
        </PlansContainer>
